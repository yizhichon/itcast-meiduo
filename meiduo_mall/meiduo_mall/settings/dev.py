...
SECRET_KEY = '*w8gy6(rya0)=*wi(tpma^jlb*wlb!@6xmcazkdppu7t59)oyu'
...
INSTALLED_APPS = [
    ...
    'django_crontab',  # 定时任务
    'haystack',# drf提供调用elasticsearch搜索引擎
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), "logs/../logs/meiduo.log"),
...
FDFS_BASE_URL = 'http://192.168.110.129:8888/'
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> E:/pycharm/kewai_itcast/Django/itcast-meiduo/meiduo_mall/logs/crontab.log/crontab.log')
]

# 解决crontab中文问题
CRONTAB_COMMAND_PREFIX = 'LANG_ALL=zh_cn.UTF-8'#:ubuntu #'LANG=zh_cn.UTF-8':max
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.110.129:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
